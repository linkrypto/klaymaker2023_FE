...
async function klaystationKaikasDeposit (addr, contAddr, amount) {
    ...
    // const block = await window.caver.rpc.klay.getBlockNumber()
    ...
    //     from: addr,
    //     to: "0xAc37926f0df5c114E044c1CFF0B21a72F8118E10",
    //     data,
    //     gas: 5021272
    // }

    // let aa = await window.caver.klay.getBalance(addr)

    // let aa = window.caver.klay.Contract({name: 'getVaultAddress',type: 'function', inputs: [{"name": "address","type": "address"}]}, "0xAc37926f0df5c114E044c1CFF0B21a72F8118E10")

    // const kk = aa.methods.getVaultAddress(addr).call()
    // console.log(kk)
    ...
    // const abi = {name: 'getVaultAddress',type: 'function', inputs: [{"name": "address","type": "address"}]}
    // const inputArray = [addr]
    ...
    // function getVaultAddress(address userAddress) external view returns (address vaultAddress);
