...
function Topnav () {
    ...
    return (
        ...
        {/* <div class="bg-gradient-to-r from-green-100 to-blue-200">  */}
            ...
            <button onClick={openChainModal} type="button" data-modal-target="crypto-modal" data-modal-toggle="crypto-modal" class="text-gray-900 mr-2 bg-white hover:bg-primary-900 hover:text-white  border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700">
                        {chain === "ethereum" ? 
                            <img class="w-4 h-4 rounded-full" src={ethereum} alt=""/>
                            :
                            // <img  src={icons["KLAY"]} alt=""/>
                            <img src={klaytnLogo} alt="Klaytn" class="w-4 h-4 rounded-full"/>
                        }
                    </button>
            <div className="relative inline-block text-left">
            {userAccount === "" ?
                    <button onClick={openModal} type="button" data-modal-target="crypto-modal" data-modal-toggle="crypto-modal" class="text-black ml-1 bg-white hover:bg-primary-900 hover:text-white  border border-gray-200 hover:bg-primary-900 hover:text-white focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center text-2xl">
                        <svg aria-hidden="true" class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path></svg>
                        Connect wallet 
                    </button>
                    :
                    <button onClick={() => dispatch(walletManageModalOpen())} type="button" data-modal-target="crypto-modal" data-modal-toggle="crypto-modal" class="text-black ml-1 bg-white hover:bg-primary-900 hover:text-white border border-gray-200 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center">                        
        ...
        {chainManageModal ? (
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">select chain</p>
                        <ul class="my-4 space-y-3">
                            ...
                            <li>
                                ...
                                <div class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                    <img class="w-6 h-6 rounded-full" src={wemixLogo} alt=""/>
                                        <span class="flex-1 ml-3 whitespace-nowrap">Wemix 3.0</span>
                                        {/* {chain === "ethereum" ? */}
                                        <span class="inline-flex items-center justify-center px-2 py-0.5 ml-3 text-xs font-medium text-gray-500 bg-gray-100 rounded dark:bg-gray-700 dark:text-gray-400">
                                            Preparing
                                        </span>
                                        {/* :
                                        <></>
      ...
      {walletConnectModal ? (
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Connect Wallet </p>
        ...
        {walletManageModal ? (
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                ...
                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Wallet change</p>
                        <ul class="my-4 space-y-3">
                            <li>
                                <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Connection</p>
